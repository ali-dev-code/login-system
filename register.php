							...
							<div class="col-lg-12">
								<form id="register-form" method="post" role="form" >
									...
									<div class="form-group">
										<input type="text" name="first_name" id="firstname" tabindex="1" class="form-control" placeholder="first name" value="" required >
									</div>
									<div class="form-group">
										<input type="text" name="last_name" id="lastname" tabindex="1" class="form-control" placeholder="lst name" value="" required >
									</div>
